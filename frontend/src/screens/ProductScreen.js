                            ...
                            <Row>
                                ...
                                <Col md={3}>
                                    <ListGroup variant='flush'>
                                        ...
                                        <ListGroup.Item>
                                            <Rating value={product.rating} text={`${product.numReviews} reviews`} color={'#f8f714'} />
                                        </ListGroup.Item>
                                ...
                                <Col md={6}>
                                    ...
                                    <ListGroup variant='flush'>
                                        ...
                                        <ListGroup.Item>
                                            ...
                                            {successProductReview && <Message variant='success'>Review sent</Message>}
                                            ...
                                            {userInfo ? (
                                                <Form onSubmit={submitHandler}>
                                                    ...
                                                    <Button disabled={loadingProductReview} type='submit' variant='primary'>Send</Button>
                                                </Form>
                                            ) : (
